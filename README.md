...
| `studio` | `None` | Студия | Непустая строка с названием студии в формате Anixart, например `"MAPPA"`, `"Bones"` или `"Kyoto Animation"` |
...
| `genres` | `None` | Жанры для включения или исключения | Список непустых строк с названиями Anixart, например `["комедия", "повседневность"]` |
